...
function mockWorkoutPlan(params) {
  ...
  const weeklySchedule = Array.from({ length: params.weeklyFrequency }, (_, index) => ({
    ...
    warmup: [
      { name: '\u5173\u8282\u73af\u7ed5\uff08\u9888/\u80a9/\u8155/\u9acb/\u8e1d\uff09', duration: '2\u5206\u949f', notes: '\u7f13\u6162\u5300\u901f\uff0c\u6bcf\u4e2a\u5173\u8282 5-8 \u5708' },
      { name: '\u539f\u5730\u8e0f\u6b65 + \u624b\u81c2\u753b\u5708', duration: '2\u5206\u949f', notes: '\u9010\u6b65\u52a0\u5feb\u8282\u594f\uff0c\u8ba9\u5fc3\u7387\u7f13\u6162\u4e0a\u5347' },
      { name: '\u52a8\u6001\u62c9\u4f38\uff08\u5f13\u6b65\u8f6c\u4f53 / \u4fa7\u5f13\u6b65\uff09', duration: '3\u5206\u949f', notes: '\u4e0d\u5f39\u9707\uff0c\u611f\u53d7\u808c\u8089\u6e29\u548c\u62c9\u957f' },
    ],
    exercises: [
      {
        ...
        searchKeyword: index % 2 === 0 ? (lowImpact ? '\u4f4e\u51b2\u51fb\u6709\u6c27' : '\u5f00\u5408\u8df3\u6559\u5b66') : '\u5f92\u624b\u6df1\u8e72\u6559\u5b66',
      },
      {
        name: '\u6b7b\u866b\u5f0f\u6838\u5fc3\u8bad\u7ec3',
        sets: 3,
        ...
        notes: '\u8170\u80cc\u8d34\u5730\uff0c\u5982\u6709\u4e0d\u9002\u7f29\u5c0f\u5e45\u5ea6',
        category: '\u6838\u5fc3',
        searchKeyword: '\u6b7b\u866b\u5f0f\u6838\u5fc3\u8bad\u7ec3\u6559\u5b66',
      },
    ],
    stretching: [
      { name: '\u5927\u817f\u540e\u4fa7\u62c9\u4f38\uff08\u5750\u59ff\u524d\u5f2f\uff09', duration: '\u6bcf\u4fa730\u79d2', notes: '\u80cc\u633a\u76f4\uff0c\u4ece\u9acb\u90e8\u524d\u503e' },
      { name: '\u81c0\u90e8\u62c9\u4f38\uff08\u5367\u59ff\u62b1\u819d\uff09', duration: '\u6bcf\u4fa730\u79d2', notes: '\u611f\u53d7\u81c0\u90e8\u6e29\u548c\u62c9\u4f38' },
      { name: '\u80a9\u80f8\u62c9\u4f38\uff08\u53cc\u624b\u80cc\u540e\u4ea4\u6263\uff09', duration: '30\u79d2', notes: '\u4e0d\u8038\u80a9\uff0c\u7f13\u6162\u52a0\u6df1' },
    ],
  }));
  return {
    goalType: params.goalType,
    summary: `\u6bcf\u5468\u8bad\u7ec3 ${params.weeklyFrequency} \u5929\uff0c\u4ee5${focus}\u4e3a\u4e3b\uff0c\u5355\u6b21\u7ea6 ${params.sessionDurationMinutes} \u5206\u949f\uff08\u542b\u70ed\u8eab\u548c\u62c9\u4f38\uff09\u3002`,
    weeklySchedule,
    restDays: Array.from({ length: 7 - params.weeklyFrequency }, (_, i) => params.weeklyFrequency + i + 1),
    reminders: [
      '\u8bad\u7ec3\u524d\u70ed\u8eab 5-10 \u5206\u949f\uff0c\u8bad\u7ec3\u540e\u62c9\u4f38\u653e\u677e 5-10 \u5206\u949f',
      '\u4efb\u4f55\u52a8\u4f5c\u5f15\u8d77\u660e\u663e\u75bc\u75db\u65f6\u7acb\u5373\u505c\u6b62',
      '\u8bad\u7ec3\u65e5\u4e4b\u95f4\u5b89\u6392\u6062\u590d\u65e5\uff0c\u4fdd\u8bc1\u7761\u7720\u548c\u8865\u6c34',
    ],
  };
  ...
  "weeklySchedule": [
    {
      "day": 1,
      "title": "\u8bad\u7ec3\u4e3b\u9898",
      "focusDescription": "\u4eca\u5929\u91cd\u70b9\u7ec3\u4ec0\u4e48\u3001\u4e3a\u4ec0\u4e48\u8fd9\u6837\u5b89\u6392",
      "durationMinutes": 45,
      "warmup": [
        {"name": "\u70ed\u8eab\u52a8\u4f5c\u540d", "duration": "3\u5206\u949f", "notes": "\u8981\u70b9"}
      ],
      "exercises": [
        {
          "name": "\u52a8\u4f5c\u540d",
          ...
          "reps": "12",
          "restSeconds": 45,
          "notes": "\u52a8\u4f5c\u8981\u9886\u3001\u5e38\u89c1\u9519\u8bef\u3001\u5b89\u5168\u63d0\u793a",
          "category": "\u6838\u5fc3|\u81c0\u817f|\u80a9\u80cc|\u624b\u81c2|\u6709\u6c27|\u5168\u8eab",
          "searchKeyword": "B\u7ad9\u641c\u7d22\u5173\u952e\u8bcd\uff08\u7528\u4e8e\u627e\u8ddf\u7ec3\u89c6\u9891\uff09"
        }
      ],
      "stretching": [
        {"name": "\u62c9\u4f38\u52a8\u4f5c\u540d", "duration": "\u6bcf\u4fa730\u79d2", "notes": "\u8981\u70b9"}
      ]
    }
  ],
  "reminders": ["\u8bad\u7ec3\u63d0\u91921", "\u8bad\u7ec3\u63d0\u91922"],
  "disclaimer": "\u5065\u5eb7\u58f0\u660e"
}

\u89c4\u5219\uff1a
1. weeklySchedule \u5929\u6570\u5fc5\u987b\u7b49\u4e8e weeklyFrequency\uff1b
2. \u6bcf\u5929\u5fc5\u987b\u5305\u542b warmup\uff083-4 \u4e2a\u70ed\u8eab\u52a8\u4f5c\uff0c\u5408\u8ba1 5-8 \u5206\u949f\uff09\u2192 exercises\uff084-6 \u4e2a\u4e3b\u8bad\u7ec3\u52a8\u4f5c\uff09\u2192 stretching\uff083-4 \u4e2a\u62c9\u4f38\u52a8\u4f5c\uff0c\u5408\u8ba1 5-8 \u5206\u949f\uff09\uff1b
3. \u6839\u636e BMI \u548c\u76ee\u6807\u8c03\u6574\u5f3a\u5ea6\uff1a\u51cf\u8102\u504f\u6709\u6c27+\u5faa\u73af\uff0c\u589e\u808c\u504f\u529b\u91cf+\u6e10\u8fdb\u8d1f\u8377\uff0c\u5851\u5f62\u504f\u6838\u5fc3+\u81c0\u817f\uff1b
4. \u65e0\u5668\u68b0\u65f6\u53ea\u80fd\u5b89\u6392\u81ea\u91cd\u578b\u52a8\u4f5c\uff1b\u6709\u5668\u68b0\u53ef\u5b89\u6392\u54d1\u94c3/\u5f39\u529b\u5e26\u7b49\uff1b
5. \u8bad\u7ec3\u65e5\u4e4b\u95f4\u5408\u7406\u8f6e\u6362\u808c\u7fa4\uff08\u5982\u4e0a\u4e0b\u80a2\u4ea4\u66ff\uff09\uff0c\u907f\u514d\u8fde\u7eed\u4e24\u5929\u7ec3\u540c\u4e00\u90e8\u4f4d\uff1b
6. searchKeyword \u7528\u4e2d\u6587\uff0c\u9002\u5408\u5728B\u7ad9\u641c\u7d22\u8ddf\u7ec3\u89c6\u9891\uff0c\u683c\u5f0f\u5982 "\u54d1\u94c3\u5367\u63a8\u6559\u5b66" "\u65b0\u624b\u81c0\u90e8\u8bad\u7ec3"\uff1b
